...
const collisionBoxes=[
  // ── MAIN ISLAND shops (scale=1.6: floor=10x6 → world 16x9.6) ──
  // Only block back+sides (not front) — hw reduced slightly for entry
  {cx:0,   cz:-28, hw:8.2, hd:3.5},  // SELL FISH back wall
  {cx:0,   cz:-22, hw:8.2, hd:2.0},  // SELL FISH sides (open front)
  {cx:30,  cz:-28, hw:8.2, hd:3.5},  // ROD SHOP back
  {cx:30,  cz:-22, hw:8.2, hd:2.0},
  {cx:-30, cz:-28, hw:8.2, hd:3.5},  // BAIT SHOP back
  {cx:-30, cz:-22, hw:8.2, hd:2.0},
  {cx:60,  cz:-28, hw:8.2, hd:3.5},  // JETSKI back
  {cx:60,  cz:-22, hw:8.2, hd:2.0},
