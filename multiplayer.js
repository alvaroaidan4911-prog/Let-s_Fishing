...
(function() {
  ...
  // ── State — HARUS di atas supaya semua fungsi bisa akses ──
  let db = null;
  let myId = null;
  let myRef = null;
  let playersRef = null;
  ...
  // ── Expose ke window SEGERA (function declarations di-hoist, jadi ini aman) ──
  window.kickPlayer             = (...a) => kickPlayer(...a);
  window.banPlayer              = (...a) => banPlayer(...a);
  window.unbanPlayer            = (...a) => unbanPlayer(...a);
  window.ownerBroadcast         = (...a) => ownerBroadcast(...a);
  window.ownerSetWeather        = (...a) => ownerSetWeather(...a);
  window.ownerGiveCoins         = (...a) => ownerGiveCoins(...a);
  window.ownerGiveCoinsToSelf   = (...a) => ownerGiveCoinsToSelf(...a);
  window.ownerClearChat         = (...a) => ownerClearChat(...a);
  window.ownerTeleportSelf      = (...a) => ownerTeleportSelf(...a);
  window.ownerTeleportTo        = (...a) => ownerTeleportTo(...a);
  window.ownerTeleportBtnStyle  = (...a) => ownerTeleportBtnStyle(...a);
  window.switchOwnerTab         = (...a) => switchOwnerTab(...a);
  window.refreshOwnerPanel      = (...a) => refreshOwnerPanel(...a);
  window.ownerGiveXP            = (...a) => ownerGiveXP(...a);
  window.ownerSetLevel          = (...a) => ownerSetLevel(...a);
  window.ownerGiveXPToAll       = (...a) => ownerGiveXPToAll(...a);
  window.ownerGiftCoins         = (...a) => ownerGiftCoins(...a);
  window.ownerGiftFish          = (...a) => ownerGiftFish(...a);
  window.ownerGiftFishToPlayer  = (...a) => ownerGiftFishToPlayer(...a);
  window.ownerGiftCoinsToPlayer = (...a) => ownerGiftCoinsToPlayer(...a);
  window.ownerAddFishToSelf     = (...a) => ownerAddFishToSelf(...a);
  window.showGiftNotif          = (...a) => showGiftNotif(...a);
  window.renderFishGiveTab      = (...a) => renderFishGiveTab(...a);
  window.renderGiftTab          = (...a) => renderGiftTab(...a);
  window.renderBannedTab        = (...a) => renderBannedTab(...a);
  ...
  if (players.length > 0) {
    ...
    players.forEach(([id, op]) => {
      ...
      html += `<div style="margin-bottom:10px">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:5px">`;
      fishTypes.forEach(f => {
        html += `<button onclick="ownerGiftFishToPlayer('${id}','${name}','${f.name}')"
          style="padding:4px 8px;background:rgba(155,89,182,0.15);
                 border:1px solid rgba(155,89,182,0.3);border-radius:7px;
                 color:#ddd;cursor:pointer;font-size:11px">
          ${f.emoji} ${f.name}
